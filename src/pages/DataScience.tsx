      ...
      <Row>
        <Col lg={6}>
          <Card className={`ds-card ${darkMode ? 'dark' : 'light'}`}>
            ...
            <Card.Body className={`ds-body ${darkMode ? 'dark' : 'light'}`}>
              <Card.Title className={`ds-title ${darkMode ? 'dark' : 'light'}`}>Completed for the Senior Project requirement at Luther
                College</Card.Title>
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>Tourism is often regarded as a positive force for its perceived effects
                on economic
        ...
        <Col lg={6}>
          <Card className={`ds-card ${darkMode ? 'dark' : 'light'}`}>
            ...
            <Card.Body className={`ds-body ${darkMode ? 'dark' : 'light'}`}>
              <Card.Title className={`ds-title ${darkMode ? 'dark' : 'light'}`}>Completed for DS420 at Luther College</Card.Title>
              ...
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>The USDA defines what’s considered a food desert and which areas will be
            ...
            <Card.Footer className={`ds-footer ${darkMode ? 'dark' : 'light'}`}>
              <a href="https://noahbjohnson.github.io/DS420" rel="noopener noreferrer" target="_blank">Visit Project Site</a>
            </Card.Footer>
          </Card>
        </Col>
        <Col lg={6}>
          <Card className={`ds-card ${darkMode ? 'dark' : 'light'}`}>
            <Card.Header className={`ds-header ${darkMode ? 'dark' : 'light'}`}>An Analysis of Politically Biased News - <i>12/6/2018</i></Card.Header>
            <Card.Body className={`ds-body ${darkMode ? 'dark' : 'light'}`}>
              <Card.Title className={`ds-title ${darkMode ? 'dark' : 'light'}`}>Completed for DS320 at Luther College</Card.Title>
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>In this report, I collected and examined articles from two biased news
              ...
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>I used the pre-trained text analysis models from indico.io and the
                Natural Language
                Toolkit(NLTK)
        ...
        <Col lg={6}>
          <Card className={`ds-card ${darkMode ? 'dark' : 'light'}`}>
            <Card.Header className={`ds-header ${darkMode ? 'dark' : 'light'}`}>Analysis of Income Bracket Data with Logistic Regression
              - <i>12/10/2017</i></Card.Header>
            <Card.Body className={`ds-body ${darkMode ? 'dark' : 'light'}`}>
              <Card.Title className={`ds-title ${darkMode ? 'dark' : 'light'}`}>Completed for MATH327 at Luther College</Card.Title>
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>The purpose of this analysis is to build a model that can accurately
        ...
        <Col lg={6}>
          <Card className={`ds-card ${darkMode ? 'dark' : 'light'}`}>
            <Card.Header className={`ds-header ${darkMode ? 'dark' : 'light'}`}>An Analysis of World Happiness Data - <i>11/3/2017</i></Card.Header>
            <Card.Body className={`ds-body ${darkMode ? 'dark' : 'light'}`}>
              <Card.Title className={`ds-title ${darkMode ? 'dark' : 'light'}`}>Completed for MATH327 at Luther College</Card.Title>
              <Card.Text className={`ds-text ${darkMode ? 'dark' : 'light'}`}>This report examines possible contributing factors to the Happiness of a
                nation’s
