...
export const DataScience = () => {
  return (
    ...
    <Container>
      ...
      <Card>
        <Card.Header>An Analysis of Politically Biased News</Card.Header>
        <Card.Body>
        ...
        <Card.Body>
          <Card.Text>In this report, I collected and examined articles from two biased news sites. Theblaze.com is a
            ...
            political biases, and they both often have their content go viral on social media. This makes them a perfect
          ...
          <Card.Text>I used the pre-trained text analysis models from indico.io and the Natural Language Toolkit(NLTK)
            to
            generate variables for analysis. Using these variables, I created visualizations using Matplotlib and
      ...
      <Card>
        <Card.Header>Analysis of Income Bracket Data with Logistic Regression</Card.Header>
        <Card.Body>
          <Card.Title>Completed for MATH327 at Luther College</Card.Title>
        </Card.Body>
        <Card.Body>
          <Card.Text>The purpose of this analysis is to build a model that can accurately determine if someone’s income
            is over $50,000 or under/equal. The data used in this analysis was downloaded from the website data.world as
      ...
      <Card>
        <Card.Header>An Analysis of World Happiness Data</Card.Header>
        <Card.Body>
          <Card.Title>Completed for MATH327 at Luther College</Card.Title>
          <Card.Subtitle> 11/3/2017 </Card.Subtitle>
        </Card.Body>
        <Card.Body>
          <Card.Text>This report examines possible contributing factors to the Happiness of a nation’s
            ...
            responses, with the exception of “country”,“year”,“HappinessSD”,“HappinessSD/mean”. The primary goal of this
